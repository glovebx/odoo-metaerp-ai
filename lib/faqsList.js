export const FAQList = {
  FAQ_EN: [
    ...
    },
    {
      ...
      answer:
        "Our moco odoo client is free, open-source, and powerful, making it ideal for various projects and marketing campaigns. It allows you to create a landing page in under an hour, simplifying the development process while also offering a high degree of customization and responsiveness.",
    },
    {
      question: "What skills do I need to use this template?",
      answer:
        "To use our moco odoo client, you only need basic web editing skills. The design of the template is intended to be easy for non-technical users to get started with, while also providing high customizability for experienced developers.",
    },
    {
      question: "How do I get started with the moco odoo client?",
      answer:
    ...
    {
      question: "Does the moco odoo client support responsive design?",
      answer:
        "Yes, our moco odoo client supports responsive design, ensuring that your webpage displays perfectly on a variety of devices, whether desktop, tablet, or smartphone.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "No. You are free to use and modify this template. At the same time, we encourage developers to submit PRs to help improve this moco odoo client together.",
    },
    {
  ...
  FAQ_ZH: [
    {
      ...
      answer:
        "支持Odoo 17以上的社区版和企业版，同时特别支持Odoo v14企业版。",
    },
    {
      question: "和官方App有何不同？",
      answer:
        "最大不同是官方App仅支持企业版，且不支持在国内使用原生消息。",
    },
    {
      question: "支持多账户登录吗？",
      answer:
    ...
    },
    {
      question: "支持PDA吗？",
      answer:
        "最新的PDA应该都能支持。部分老PDA的系统内置组件版本过低，可能无法正常使用。",
    },
    {
